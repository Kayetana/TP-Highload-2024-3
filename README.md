...
|:--------------|-------------|--------------------------------------------|----------------------|-----------------------|----------------------|
| k8s node      | Собственный | 64 CPU Cores / 4×16 GB RAM / 2x240 GB SSD  | 1 330                | 11 800 $              | 24 000 $             |
...
```
1330 * 24000 + 10 * 20000 + 5 * 20000 + 5 * 10000 + 15 * 10000 + 30 * 16000 + 80 * 20000 + 40 * 20000 = 35 300 000  
Стоимость аренды = ~35 млн $
```
...
Вывод: покупка выгоднее чем аренда.

```
18 335 500 + 68 100 000 = 86 435 500 $
Стоимость всех ресурсов с учетом Amazon S3: ~86 млн $
```
