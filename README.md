...
То есть нужно учитывать все возможные варианты префиксов.
Допустим, что размер этих индексов составляет ~1 Тб 
...
В таблице представлена стоимость покупки [[13]](https://www.broadberry.eu/rackmount-servers) и стоимость аренды.

| Сервис        | Хостинг     | Конфигурация                               | Количество машин | Покупка 1 шт на 5 лет | Аренда 1 шт на 5 лет | 
|:--------------|-------------|--------------------------------------------|------------------|-----------------------|----------------------|
| k8s node      | Собственный | 64 CPU Cores / 8x32 GB RAM / 2x250 GB SSD  |                  | 11 330 $              |                      |
| Redis         | Собственный | 16 CPU Cores / 4×16 GB RAM / 2x240 GB SSD  | 1 * 5 ДЦ = 5     | 6 500 $               |                      |
| Chroma        | Собственный | 16 CPU Cores / 4×16 GB RAM / 2x240 GB SSD  | 1 * 5 ДЦ = 5     | 6 500 $               |                      |
| Elasticsearch | Собственный | 16 CPU Cores / 4×64 GB RAM / 2x960 GB SSD  | 1 * 5 ДЦ = 5     | 7 800 $               |                      |
| ClickHouse    | Собственный | 16 CPU Cores / 4×64 GB RAM / 4x1.9 TB SSD  | 1 * 5 ДЦ = 5     | 9 000 $               |                      |
| Cassandra     | Собственный | 16 CPU Cores / 4×64 GB RAM / 4x7.6 TB SSD  | 2 * 5 ДЦ = 10    | 11 000 $              |                      |
| Aerospike     | Собственный | 16 CPU Cores / 4×64 GB RAM / 10x7.6 TB SSD | 8 * 5 ДЦ = 40    | 17 000 $              |                      |
| FlockDB       | Собственный | 16 CPU Cores / 4×64 GB RAM / 10x7.6 TB SSD | 8 * 5 ДЦ = 40    | 17 000 $              |                      |
